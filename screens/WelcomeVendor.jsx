      ...
      >
        <View style={styles.wrapper}>
          ...
          <View style={styles.heroWrapper}>
            ...
            <Text style={styles.heroDescWrapper}>
              <Text style={styles.heroTitle}>Relax and Sell on </Text>
              <Text style={styles.heroKeyword}>Suru</Text>
            </Text>
            <Text style={styles.heroPar}>
              {" "}
              Get your products in front of a thousand customers, register under 5 minutes to get started.
            </Text>
        ...
        <View style={styles.bottomWrapper}>
            ...
            activeOpacity={0.8}
              ...
              onPress={() => navigation.navigate("Form", { name: "Form" })}
            >
              <Text style={styles.btnPrimary}>Start Selling</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
