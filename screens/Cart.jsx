...
const Cart = ({ navigation, route }) => {
  ...
  let prodType = route.params.type;

  if(prodType == 'product'){
    product = products[route.params.productId - 1]; 
  }else{
    product = baskets[route.params.productId - 1]; 
  }
  ...
  return (
    ...
    >
        ...
        <View style={styles.imageWrapper}>
          <Image
            ...
            source={{uri: prodType == 'product' ? product.imgUrl : product.image}}
          />
        </View>
        <View style={styles.itemNameWrapper}>
          <Text style={styles.itemName}>{prodType == 'product' ? product.title : product.name}</Text>
        </View>
    ...
    <TouchableOpacity onPress={() => setAddToCart(false)} style={{
      backgroundColor: "#000",
      opacity: 0.4,
      height: "100%",
      width: "100%"
      ...
      <View style={{
        ...
        <View style={{
          ...
          <Icon name="close-outline" onPress={() => setAddToCart(false)} size={30} />
        </View>
        
        <CartItem item={product.id} />
